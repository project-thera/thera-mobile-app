      ...
      weightsAssets.map(async (weightsAsset) => {
        ...
        if (Platform.OS === 'android') {
          ...
          try {
            ...
            throw new Error(
              `Error reading resource ${fileName}. Make sure the file is in located in the res/raw folder of the bundle`,
            );
          }
        } else {
          try {
...
export function bundleResourceIO(modelJson, modelWeightsId) {
  console.log(modelWeightsId);
  console.log('bundleResourceIO');
